...
You are not buying a support contract, a service-level guarantee, or ongoing feature development. I (the developer) will make best-effort improvements but do not commit to any release schedule.

## 3. Refunds

Refunds are handled by Google Play under [Google Play's refund policy](https://support.google.com/googleplay/answer/2479637). If you are within Google's refund window, request the refund through the Play Store. Outside that window, email me and I will assess case-by-case, but I cannot process refunds directly — only Google can move money back into your account.
...
- Use the app to track subscriptions that belong to someone else without their knowledge, if doing so would violate any law that applies to you.
...
To the maximum extent permitted by law, my total liability to you for any claim arising out of or related to the app is limited to the amount you paid for the app. I am not liable for any indirect, incidental, consequential, or special damages, including lost profits or missed subscription cancellations.

Nothing in these terms limits liability that cannot be limited under applicable consumer-protection laws (for example, mandatory warranties under the Brazilian Consumer Defense Code or EU consumer law). If you are a consumer in a jurisdiction where the above limits are narrower than local law permits, the local-law limits apply.
...
I may update these terms. Material changes will be posted at the URL where you found this page with a new "Last updated" date. Continued use after a material change means you accept the updated terms.

## 10. Governing law

These terms are governed by the laws of Brazil, without regard to its conflict-of-laws rules, except where mandatory consumer-protection laws in your country of residence apply.

## 11. Contact

Vitor Andrade — vitormachadodeandrade@gmail.com
